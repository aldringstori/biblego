...
const GoTextarea$1 = /*@__PURE__*/ proxyCustomElement(class GoTextarea extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.hasNamedSlot = {};
    ...
    static get style() { return GoTextareaStyle0; }
}, [4, "go-textarea", {
        "labelId": [1, "label-id"],
...
function defineCustomElement$1() {
    ...
    const components = ["go-textarea", "go-field"];
    components.forEach(tagName => { switch (tagName) {
        case "go-textarea":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, GoTextarea$1);
            }
            break;
        case "go-field":
            if (!customElements.get(tagName)) {
...
const GoTextarea = GoTextarea$1;
const defineCustomElement = defineCustomElement$1;

export { GoTextarea, defineCustomElement };
