...
const GoRadio$1 = /*@__PURE__*/ proxyCustomElement(class GoRadio extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
    ...
    static get style() { return GoRadioStyle0; }
}, [4, "go-radio", {
        "checked": [1028],
        "indeterminate": [4],
        "name": [1],
...
function defineCustomElement$1() {
    ...
    const components = ["go-radio"];
    components.forEach(tagName => { switch (tagName) {
        case "go-radio":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, GoRadio$1);
            }
            break;
    } });
}
...
const GoRadio = GoRadio$1;
const defineCustomElement = defineCustomElement$1;

export { GoRadio, defineCustomElement };
