...
import { d as defineCustomElement$3 } from './go-dropdown2.js';
...
const GoSelect$1 = /*@__PURE__*/ proxyCustomElement(class GoSelect extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
    ...
    static get style() { return GoSelectStyle0; }
}, [4, "go-select", {
        "name": [1],
        "label": [1],
        "labelId": [1, "label-id"],
...
function defineCustomElement$1() {
    ...
    const components = ["go-select", "go-dropdown", "go-field"];
    components.forEach(tagName => { switch (tagName) {
        case "go-select":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, GoSelect$1);
            }
            break;
        case "go-dropdown":
            if (!customElements.get(tagName)) {
...
const GoSelect = GoSelect$1;
const defineCustomElement = defineCustomElement$1;

export { GoSelect, defineCustomElement };
