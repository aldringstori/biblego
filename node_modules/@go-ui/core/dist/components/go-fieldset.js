...
import { b as hasSlot, d as initIdProps } from './helper.js';
...
const GoFieldset$1 = /*@__PURE__*/ proxyCustomElement(class GoFieldset extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
    ...
    static get style() { return GoFieldsetStyle0; }
}, [4, "go-fieldset", {
        "label": [1],
        "hint": [1],
        "error": [8],
...
function defineCustomElement$1() {
    ...
    const components = ["go-fieldset"];
    components.forEach(tagName => { switch (tagName) {
        case "go-fieldset":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, GoFieldset$1);
            }
            break;
    } });
}
...
const GoFieldset = GoFieldset$1;
const defineCustomElement = defineCustomElement$1;

export { GoFieldset, defineCustomElement };
