...
import { d as defineCustomElement$2 } from './go-link2.js';
...
const GoCard$1 = /*@__PURE__*/ proxyCustomElement(class GoCard extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
    ...
    get el() { return this; }
    static get style() { return GoCardStyle0; }
}, [4, "go-card", {
        "heading": [1],
...
function defineCustomElement$1() {
    ...
    const components = ["go-card", "go-link"];
    components.forEach(tagName => { switch (tagName) {
        case "go-card":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, GoCard$1);
            }
            break;
        case "go-link":
            if (!customElements.get(tagName)) {
...
const GoCard = GoCard$1;
const defineCustomElement = defineCustomElement$1;

export { GoCard, defineCustomElement };
