...
import { c as commonjsGlobal, J as JSON5 } from './index2.js';
import { g as goUiPlugin } from './go-ui-md-plugin.js';
...
const GoMd$1 = /*@__PURE__*/ proxyCustomElement(class GoMd extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
    ...
    static get style() { return GoMdStyle0; }
}, [4, "go-md", {
        "inline": [4],
        "content": [1025],
        "src": [1],
        "mdOptions": [1, "md-options"],
        "sanitise": [4],
        "useGoUi": [4, "use-go-ui"]
    }, undefined, {
        "src": ["handleSrcChange"],
...
function defineCustomElement$1() {
    ...
    const components = ["go-md"];
    components.forEach(tagName => { switch (tagName) {
        case "go-md":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, GoMd$1);
            }
            break;
    } });
}
...
export { GoMd, defineCustomElement };
