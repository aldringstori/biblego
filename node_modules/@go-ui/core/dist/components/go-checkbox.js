...
const GoCheckbox$1 = /*@__PURE__*/ proxyCustomElement(class GoCheckbox extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
    ...
    static get style() { return GoCheckboxStyle0; }
}, [4, "go-checkbox", {
        "checked": [1028],
        "indeterminate": [4],
        "name": [1],
...
function defineCustomElement$1() {
    ...
    const components = ["go-checkbox"];
    components.forEach(tagName => { switch (tagName) {
        case "go-checkbox":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, GoCheckbox$1);
            }
            break;
    } });
}
...
const GoCheckbox = GoCheckbox$1;
const defineCustomElement = defineCustomElement$1;

export { GoCheckbox, defineCustomElement };
