...
const GoProgress$1 = /*@__PURE__*/ proxyCustomElement(class GoProgress extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.min = 0;
    ...
    static get style() { return GoProgressStyle0; }
}, [4, "go-progress", {
        "min": [2],
        "max": [2],
        "value": [1026],
...
function defineCustomElement$1() {
    ...
    const components = ["go-progress"];
    components.forEach(tagName => { switch (tagName) {
        case "go-progress":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, GoProgress$1);
            }
            break;
    } });
}
...
const GoProgress = GoProgress$1;
const defineCustomElement = defineCustomElement$1;

export { GoProgress, defineCustomElement };
