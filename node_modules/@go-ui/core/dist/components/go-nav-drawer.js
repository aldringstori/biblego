...
import { p as parseJsonProp, i as inheritAttributes } from './helper.js';
import { d as trapFocus } from './dom.js';
import { r as renderIcon } from './nav-helpers.js';
import { d as defineCustomElement$6 } from './go-button2.js';
import { d as defineCustomElement$5 } from './go-icon2.js';
import { d as defineCustomElement$4 } from './go-link2.js';
...
const GoNavDrawer$1 = /*@__PURE__*/ proxyCustomElement(class GoNavDrawer extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
    ...
    static get style() { return GoNavDrawerStyle0; }
}, [4, "go-nav-drawer", {
        "position": [513],
        "items": [1],
        "active": [1540],
...
function defineCustomElement$1() {
    ...
    const components = ["go-nav-drawer", "go-button", "go-icon", "go-link", "go-overlay", "go-spinner"];
    components.forEach(tagName => { switch (tagName) {
        case "go-nav-drawer":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, GoNavDrawer$1);
            }
            break;
        case "go-button":
            if (!customElements.get(tagName)) {
...
const GoNavDrawer = GoNavDrawer$1;
const defineCustomElement = defineCustomElement$1;

export { GoNavDrawer, defineCustomElement };
