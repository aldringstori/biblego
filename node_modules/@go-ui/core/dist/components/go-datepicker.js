...
import { b as loadFieldSlots, l as loadFieldProps, f as fieldSlotNames } from './form.js';
import { p as parseJsonProp } from './helper.js';
import { c as commonjsGlobal } from './index2.js';
import { d as defineCustomElement$3 } from './duet-date-picker2.js';
...
const GoDatepicker$1 = /*@__PURE__*/ proxyCustomElement(class GoDatepicker extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
    ...
    static get style() { return GoDatepickerStyle0; }
}, [4, "go-datepicker", {
        "labelId": [1, "label-id"],
...
function defineCustomElement$1() {
    ...
    const components = ["go-datepicker", "duet-date-picker", "go-field"];
    components.forEach(tagName => { switch (tagName) {
        case "go-datepicker":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, GoDatepicker$1);
            }
            break;
...
const GoDatepicker = GoDatepicker$1;
const defineCustomElement = defineCustomElement$1;

export { GoDatepicker, defineCustomElement };
