...
const DuetDatePicker = /*@__PURE__*/ proxyCustomElement(class DuetDatePicker extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
...
function defineCustomElement() {
    ...
    const components = ["duet-date-picker"];
    components.forEach(tagName => { switch (tagName) {
        case "duet-date-picker":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, DuetDatePicker);
            }
            break;
    } });
}
...
export { DuetDatePicker as D, defineCustomElement as d };

//# sourceMappingURL=duet-date-picker2.js.map