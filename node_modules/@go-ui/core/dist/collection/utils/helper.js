 ...
 */
export const inheritAttributes = (el, excludes = [], remove = true) => {
    if (!el) {
        return {};
    }
 ...
 */
export function inheritComponentAttrs(component, excludes = [], remove = true) {
    if (!component.el) {
...
export function hasSlot(el, slotName) {
 ...
 */
export function selectDirectChildren(elem, selector) {
 ...
 */
export function initIdProps(instance, rootEl, idProps, prefix) {
 ...
 * @param prop {T|string}
 */
export function parseJsonProp(prop) {
    if (!prop) {
        return null;
    }
    try {
