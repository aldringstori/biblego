 ...
 * @param el target element
 */
export function fadeOutRemove(el, callback) {
 ...
 * @returns
 */
export function getLastFocusableChild(parent) {
 ...
 */
export function trapFocus(parent, focusOnFirst = true) {
...
export function focusFirstWithin(parent) {
    const focusableChildren = getFocusableChildren(parent);
    const firstFocusableEl = focusableChildren[0];
    if (firstFocusableEl) {
        setTimeout(() => {
...
export function focusLastWithin(parent) {
