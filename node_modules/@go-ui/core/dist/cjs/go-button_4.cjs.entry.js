...
const kebabCase = require('./kebabCase-f98d4407.js');
...
const GoButton = class {
    ...
    componentWillLoad() {
        ...
        if (this.icon) {
            if (!this.el.hasAttribute('aria-label') && !this.el.hasAttribute('aria-labelledby')) {
                helper.warning(`go-button with icon must have either aria-label or aria-labelledby attribute`, this.el);
            }
        }
        if (this.block) {
    ...
    updateInnerButtonAttributes() {
        this.inheritedAttributes = Object.assign({}, helper.$attrs.bind(this)());
    }
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'd576c9b1b247d00a45ba31398026f58fba47a1c7', class: {
                [rootClasses]: true,
                outline,
                'outline outline-fill': outlineFill,
            } }, index.h(Tag, Object.assign({ key: '6483cc7a4f95a7d5747e60c2041a40d85276b470', ref: (el) => {
                this.nativeEl = el;
            }, href: href ? href : null, type: href ? null : type, "aria-disabled": disabled ? 'true' : null, disabled: disabled ? 'true' : null, class: "inner-button", "aria-busy": loading ? 'true' : null }, inheritedAttributes), index.h("go-spinner", { key: 'a42682d6643e9c729bd813d151d00c5e2147c924', loading: loading, loadingAnnouncement: loadingAnouncement }), index.h("slot", { key: 'd680216f9af9576e5ac1d092249defbbabc1aa79', name: "prefix" }), index.h("span", { key: '6d2a89fb1c3eb0bc0d4ae8b1ce615435507587f1', class: "btn-text" }, index.h("slot", { key: 'ccec91661523e0e7eb53ac68cb242cf240e9d7e1' })), index.h("slot", { key: 'b89c2277b3c99ad9f8d9614ec0ae603ff2411edd', name: "suffix" }))));
    }
...
const GoDarkMode = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.changeEvent = index.createEvent(this, "themechange", 7);
...
const GoSpinner = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'b0e25d5a20715c17b5797453c7b90a320866d7b8', style: styles, role: "status", class: { stacked, 'visually-hidden': !isLoading } }, isLoading
            ? [
                index.h("div", { "aria-hidden": "true", class: "spinner" }),
                index.h("slot", null, index.h("span", { class: "visually-hidden" }, loadingAnnouncement)),
            ]
            : null));
    }
    get el() { return index.getElement(this); }
...
const GoSwitch = class {
    ...
    componentWillLoad() {
        ...
        const attributeNames = propNames.map((name) => kebabCase.kebabCase(name));
        this.attrs = helper.inheritAttributes(this.el, ['class', 'style', ...attributeNames]);
    }
    render() {
        const { checked, name, label, disabled, value, attrs, stack, fullWidth, showOnOff, showOnOffOutside, activeLabel, inactiveLabel, } = this;
        const inputId = (attrs === null || attrs === void 0 ? void 0 : attrs.id) ? attrs.id : uniqueId.uniqueId('go-switch-');
        return (index.h(index.Host, { key: '5205c5cc2d8ff827433dfe31289927dcec6cfc01', class: { stack, 'full-width': fullWidth } }, index.h("label", { key: '312120a1f35c7f4956544995380b85576bab6d07', htmlFor: inputId }, label), index.h("div", { key: '4877f7f01bb8503af40f52c306c1ddc96b05d78f', class: "switch-container" }, index.h("input", Object.assign({ key: '652dc70bdfac1a35ecb4a5b94b8ca8cce47e06f0', ref: (el) => (this.inputEl = el), type: "checkbox", role: "switch", id: inputId, name: name, disabled: disabled, checked: checked, value: value }, attrs, { onChange: (e) => this.handleChange(e) })), index.h("div", { key: '93b6eb2c496a939e359cade903182008c33dc7f8', class: "switch-group" }, index.h("span", { key: '19e88239b026e86f64218c2f7854a9dc7f9e338f', class: "switch-track" }, index.h("span", { key: 'c6990120f0da04598ebda7e4217227c2253fd4da', class: "switch-handle" }), showOnOff ? (index.h("span", { class: "switch-text", "aria-hidden": "true" }, checked ? activeLabel : inactiveLabel)) : null), showOnOffOutside ? (index.h("span", { class: "text-size-0", "aria-hidden": "true" }, checked ? activeLabel : inactiveLabel)) : null))));
    }
    get el() { return index.getElement(this); }
};
GoSwitch.style = GoSwitchStyle0;

exports.go_button = GoButton;
exports.go_dark_mode = GoDarkMode;
exports.go_spinner = GoSpinner;
exports.go_switch = GoSwitch;

//# sourceMappingURL=go-button_4.cjs.entry.js.map