...
const GoRadio = class {
    ...
    componentWillLoad() {
        ...
        helper.initIdProps(this, this.el, ['hint', 'error', 'control'], 'go-radio-');
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '75cc6e73b7ac137ad89b18f0f624dbd7bc8f3c9a', class: {
                error: hasError,
                disabled: !!disabled,
            } }, index.h("div", { key: '67e3411f8b8ddbf514890f9b040cb329514a659b', class: "control-wrapper" }, index.h("div", { key: 'b7af3fbc16559ac6be09e3ea7f9b44a7e54cc929', class: "box" }, index.h("input", Object.assign({ key: 'f02218a33fc42a56e0298b7536da0b948c3b21e2' }, props, { type: "radio", class: "hidden-control", "aria-invalid": String(hasError), "aria-describedby": describedByIds.join(' ') })), index.h("span", { key: '8cc88f51d17e12a9fd2d15a64d5bc8653f78af05', class: "mark" }, index.h("span", { key: '363ab04516f45bfb5919f8b59c06d301189a974f', class: "dot" }))), index.h("div", { key: '1e57ffaf81431d0070850b63b19a65bdd3b188a3', class: "text" }, index.h("label", { key: '816ba31489793c5382cd7fbe73fe8ac6d25750d5', htmlFor: controlId }, label), hasHintSlot || hint ? (index.h("div", { class: "hint", id: hintId }, index.h("slot", { name: "hint" }, hint))) : null)), hasError ? (index.h("div", { class: "error-msg", id: errorId }, error)) : null));
    }
...
exports.go_radio = GoRadio;

//# sourceMappingURL=go-radio.cjs.entry.js.map