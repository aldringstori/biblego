...
const GoDropdownMenu = class {
    ...
    componentWillLoad() {
        ...
        if (!this.menuId) {
            this.menuId = uniqueId.uniqueId('go-dropdown-menu-');
        }
    ...
    render() {
        ...
        return (index.h("go-dropdown", Object.assign({ key: '10c25f5db589edffe3f4b92dfdbf88f41123f761', ref: (el) => {
                this.dropdownEl = el;
            }, noTriggerClickHandler: true, onOpened: () => this.handleDropdownOpened(), onClosed: () => this.handleDropdownClosed() }, dropdownProps), index.h("slot", { key: '90a88209517d7408e48aa283b666f5a158b508b5', name: "prefix" }), index.h("div", { key: 'b4ae2290f95f499281f4ec13386f1b34c12560cb', role: "menu", class: "dropdown-menu-inner", id: menuId, ref: (el) => {
                this.menuEl = el;
            } }, index.h("slot", { key: '2f94ef98bbfc7bed961444f033331525327d2f9a' })), index.h("slot", { key: 'f6fbf3cb42f70d7c785e8f1f4078eea78444c19a', name: "suffix" })));
    }
    get el() { return index.getElement(this); }
};
GoDropdownMenu.style = GoDropdownMenuStyle0;

exports.go_dropdown_menu = GoDropdownMenu;

//# sourceMappingURL=go-dropdown-menu.cjs.entry.js.map