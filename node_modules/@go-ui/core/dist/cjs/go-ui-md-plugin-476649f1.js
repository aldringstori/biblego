...
function goUiPlugin(md) {
    ...
    // links
    md.use(markdownItForInline, 'go-link', 'link_open', function (tokens, idx) {
...
exports.goUiPlugin = goUiPlugin;

//# sourceMappingURL=go-ui-md-plugin-476649f1.js.map