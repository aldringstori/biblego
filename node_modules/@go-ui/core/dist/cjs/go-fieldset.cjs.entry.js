...
const GoFieldset = class {
    ...
    componentWillLoad() {
        ...
        helper.initIdProps(this, this.el, ['label', 'hint', 'error'], 'go-fieldset-');
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '6fad526b8cd1448c504f73b7714bc9d2fe2737c8' }, index.h("fieldset", { key: 'b786d5e94ed072c53e70b2b692202f0783dc8222', class: {
                'go-field': true,
                'error': hasError,
            }, "aria-invalid": hasError }, index.h("legend", { key: 'd77e589b6731aeb4ac2575d5386b079b67916766' }, index.h("span", { key: '33dd6c354a651edaec9ab0379d7f10b55c02de05', class: "label", id: labelId }, label), hasHintSlot || hint ? (index.h("span", { class: "hint", id: hintId }, index.h("slot", { name: "hint" }, hint))) : null, index.h("span", { key: '22563c875c0374b67d417f4c1ca469571ab95a7e', class: "visually-hidden" }, hasError ? index.h("span", { id: errorId }, "Invalid: ", error) : null)), index.h("div", { key: 'b38cd10ecec44d522092cda2470b90a947c87e9a', class: "fieldset-content" }, index.h("slot", { key: '717988471b6a848400ee3c1920116b1e34ea75ee' })), hasError ? (index.h("div", { class: "error-msg", id: errorId }, error)) : null)));
    }
...
exports.go_fieldset = GoFieldset;

//# sourceMappingURL=go-fieldset.cjs.entry.js.map