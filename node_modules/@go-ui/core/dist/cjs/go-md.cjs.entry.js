...
const goUiMdPlugin = require('./go-ui-md-plugin-476649f1.js');
...
const goMdCss = "go-md{display:block}go-md go-banner .icon-col svg{width:1.5rem}";
const GoMdStyle0 = goMdCss;

const GoMd = class {
    constructor(hostRef) {
        index$1.registerInstance(this, hostRef);
        this.init = index$1.createEvent(this, "init", 7);
        this.rendered = index$1.createEvent(this, "rendered", 7);
        this.inline = false;
    ...
    createMdInstance() {
        ...
        if (typeof mdOptions === 'string') {
            try {
                options = index.JSON5.parse(mdOptions);
            }
            catch (e) {
    ...
    async initialiseRenderer() {
        ...
        if (this.useGoUi) {
            this.md.use(goUiMdPlugin.goUiPlugin);
        }
    }
    /**
    ...
    render() {
        return (index$1.h(index$1.Host, { key: '30593d0b0d9324a746c9357360816d8b0ffc982f' }, index$1.h("slot", { key: 'e2e396b73b6aaec2f7b478204b8338d63bb9692d' })));
    }
    get el() { return index$1.getElement(this); }
    static get watchers() { return {
        "src": ["handleSrcChange"],
        "content": ["handleContentChange"],
        "mdOptions": ["handleMdOptionsChange"]
    }; }
};
GoMd.style = GoMdStyle0;

exports.go_md = GoMd;

//# sourceMappingURL=go-md.cjs.entry.js.map