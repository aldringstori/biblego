...
const GoIcon = class {
    ...
    componentWillLoad() {
        this.attrs = helper.$attrs.bind(this)(false);
    }
    render() {
        ...
        return (
        // prettier-ignore
        index.h(index.Host, { key: 'acc17652d28df2698689629703ce294d6f0dbec5', "aria-hidden": label ? 'false' : 'true', style: {
                '--icon-size': size ? size : null,
                '--icon-color': color ? color : null,
            } }, label ? index.h("span", { class: "visually-hidden" }, label) : null, iconSet.startsWith('material') ? index.h("span", { class: `${iconSet} go-icon ${customClasses ? customClasses : ''}` }, name) : null, iconSet.startsWith('fa') ? index.h("i", { class: `${iconSet} fa-${name} go-icon ${customClasses ? customClasses : ''}` }) : null, iconSet.startsWith('bx') ? index.h("i", { class: `bx ${iconSet}-${name} go-icon ${customClasses ? customClasses : ''}` }) : null));
    }
    get el() { return index.getElement(this); }
};
GoIcon.style = GoIconStyle0;
...
const GoNavLink = class {
    ...
    parseNavItem() {
        ...
        const icon = (_a = helper.parseJsonProp(this.icon)) !== null && _a !== void 0 ? _a : (_b = this.parsedItem) === null || _b === void 0 ? void 0 : _b.icon;
        const linkAttrs = (_c = helper.parseJsonProp(this.linkAttrs)) !== null && _c !== void 0 ? _c : (_d = this.parsedItem) === null || _d === void 0 ? void 0 : _d.linkAttrs;
    ...
    componentWillLoad() {
        this.inheritedAttrs = helper.$attrs.bind(this)();
        this.parseNavItem();
    }
    render() {
        const { inheritedAttrs } = this;
        if (!this.parsedItem) {
            return (index.h("a", Object.assign({}, inheritedAttrs), index.h("slot", null)));
        }
        ...
        return (index.h(index.Host, null, index.h(Tag, Object.assign({}, attrs), icon ? typeof icon === 'string' ? index.h("go-icon", { name: icon }) : index.h("go-icon", Object.assign({}, icon)) : null, index.h("span", { class: "nav-link-text" }, index.h("span", { class: "nav-link-text-label" }, label), description ? index.h("span", { class: "nav-link-text-description" }, description) : null), url && this.showArrow ? (index.h("svg", { class: "arrow", xmlns: "http://www.w3.org/2000/svg", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", viewBox: "0 0 24 24", focusable: "false", "aria-hidden": "true" }, index.h("line", { x1: "5", y1: "12", x2: "19", y2: "12" }), index.h("polyline", { points: "12 5 19 12 12 19" }))) : null)));
    }
    get el() { return index.getElement(this); }
...
GoNavLink.style = GoNavLinkStyle0;

exports.go_icon = GoIcon;
exports.go_nav_link = GoNavLink;

//# sourceMappingURL=go-icon_2.cjs.entry.js.map