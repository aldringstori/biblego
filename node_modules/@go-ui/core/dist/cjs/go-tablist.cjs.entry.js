...
const GoTablist = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.activated = index.createEvent(this, "activated", 7);
        this.activeIndex = -1;
        this.tabEls = [];
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'a0cf0f48424e888c2acd327f0fe8cba77ec2edc4', class: { vertical, fill }, style: vertical
                ? {
                ...
                } }, index.h("div", { key: '23489fad7ad487664e3d6c6068b4d6fc52406a58', role: "tablist", ref: (el) => (this.tablistEl = el), "aria-label": label, "aria-orientation": vertical ? 'vertical' : undefined, style: { 'justify-content': JUSTIFY_VALUES_MAP[justify] } }, tabsState
            ? tabsState.map((tab, index$1) => {
                return (index.h("button", { type: "button", role: "tab", "aria-selected": tab.active ? 'true' : 'false', tabindex: tab.active ? undefined : '-1', "aria-controls": tab.panelId, id: tab.tabId, onClick: () => this.onTabClick(index$1), onKeyDown: (e) => this.onKeydown(e), key: index$1, class: {
                        'active': tab.active,
                        'has-active-icon': !!tab.iconActiveSlot,
                    }, ref: (el) => this.tabEls.push(el) }, index.h("span", { class: { 'visually-hidden': tab.iconOnly } }, tab.label)));
            })
            : null, index.h("div", { key: '81edcc863b34a65ee84f2bd4372d872f818a2973', class: "tabs-active-indicator-track", "aria-hidden": "true" }, index.h("div", { key: 'b4712cd3de03b8dd16b9360ac47ba2461f46a818', class: "tabs-active-indicator" })))));
    }
...
GoTablist.style = GoTablistStyle0;

exports.go_tablist = GoTablist;

//# sourceMappingURL=go-tablist.cjs.entry.js.map