...
const parseSelectOptions = (options) => {
    try {
        ...
        const parsedOptions = helper.parseJsonProp(options);
        if (parsedOptions) {
...
const GoSelect = class {
    constructor(hostRef) {
        ...
        this.goChange = index.createEvent(this, "gochange", 7);
        this.hasNamedSlot = {};
    ...
    async componentWillLoad() {
        this.loadOptions();
        this.attrs = form.inheritNonFieldAttrs(this, ['options']);
    ...
    render() {
        ...
        const controlAttrs = Object.assign({ id,
            ...
            value }, attrs);
        return [
            index.h("input", { key: 'e0629e8341cc8de396181f3b70984596b1ebba99', type: "hidden", name: name, value: value }),
            index.h("go-field", Object.assign({ key: 'ecd385c79dbda6b291720128fd9776dea26539ae' }, fieldProps), form.fieldSlotNames.map((slotName) => {
                if (this.hasNamedSlot[slotName]) {
                    return (index.h("template", { slot: slotName }, index.h("slot", { name: slotName })));
                }
            }), index.h("div", { key: 'd3974d11d05c04d80183f99968d7b79d3a73b854', class: "combo" }, index.h("div", Object.assign({ key: '11818aed0daf7fbb3f9807fcfcbfca37c9e66aad' }, controlAttrs, { role: "combobox", "aria-activedescendant": activeId, "aria-autocomplete": "none", "aria-haspopup": "listbox", "aria-expanded": `${open}`, "aria-labelledby": `${id} ${id}-value`, "aria-controls": `${id}-listbox`, "aria-disabled": disabled ? 'true' : undefined, "aria-readonly": readonly ? 'true' : undefined, class: "control", id: `${id}-value`, ref: (el) => (this.inputRef = el), tabindex: "0", onBlur: this.onComboBlur.bind(this), onKeyDown: this.onComboKeyDown.bind(this) }), index.h("span", { key: 'c20c10a5c913fad61b0087a2be026182613cbd1f' }, parsedOptions && ((_a = parsedOptions[activeIndex]) === null || _a === void 0 ? void 0 : _a.label) ? parsedOptions[activeIndex].label : ''), index.h("svg", { key: '625801aecfeefce95606b7b02cfa62530370ff3f', class: { arrow: true, open }, xmlns: "http://www.w3.org/2000/svg", "aria-hidden": "true", fill: "none", stroke: "currentColor", "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-width": "2", viewBox: "0 0 24 24" }, index.h("path", { key: '0c5bbf258fd6d304b1b6e4525e5614ad5df3c448', d: "m6 9 6 6 6-6" }))), index.h("go-dropdown", { key: '8528d780e281a08017dc05215a2ba728a21851de', disabled: readonly || disabled, "trigger-selector": `#${id}-value`, width: dropdownWidth, onOpened: () => {
                    this.updateMenuState(true);
                }, onClosed: () => {
                    this.updateMenuState(false);
                }, role: "listbox", ref: (el) => (this.listboxRef = el), id: `${id}-listbox` }, parsedOptions &&
                parsedOptions.map((option, i) => {
                    return (index.h("div", { class: { 'current': this.activeIndex === i, 'combo-option': true }, id: `${id}-${i}`, "aria-selected": this.activeIndex === i ? 'true' : undefined, ref: (el) => {
...
exports.go_select = GoSelect;

//# sourceMappingURL=go-select.cjs.entry.js.map