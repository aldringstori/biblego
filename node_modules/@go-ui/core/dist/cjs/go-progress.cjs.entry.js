...
const GoProgress = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '71869d0f9c7c5b089da9aef617a2c548a2e32365' }, index.h("div", Object.assign({ key: '4fd1f11ddde42997fc3a0d9d69f7b78c58b2fb2a', class: { track: true, indeterminate }, "aria-label": label, "aria-labelledby": labelledby, role: "progressbar" }, ariaAttrs), index.h("slot", { key: 'bd7c57acd1bc834437b43d822a8663947a7c1285' }), index.h("span", { key: 'fe1e45107f322aaf96b9e028340c86ced3e72946', class: "bar", style: indeterminate ? null : { transform: `translateX(-${100 - percentage}%` } })), showPercentage ? index.h("span", { class: "percentage" }, percentage, "%") : null));
    }
...
exports.go_progress = GoProgress;

//# sourceMappingURL=go-progress.cjs.entry.js.map